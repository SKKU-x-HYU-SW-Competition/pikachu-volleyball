/**
 * Gauge -- the resource that skills will be bought with (decision D-019).
 *
 ...
 * serve", D-019 says this becomes GAUGE_ON_RECEIVE -- this constant is the
...
export class GaugeTracker {
  ...
  /**
   * Reset both gauges. Called when a new match starts (D-019: gauge survives
