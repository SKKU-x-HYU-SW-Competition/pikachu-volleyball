...
게임 화면 상단 메뉴바의 **"Bot Setup"** 버튼을 누르면 패널이 열립니다.
...
| 시나리오 | LEFT | RIGHT |
|---|---|---|
| 내 봇 감각으로 붙기 | Keyboard | Bot |
| 내 봇 vs 내장 AI | Bot | AI |
| 두 버전 붙이기 | Bot (v1) | Bot (v2) |

**"Apply"를 누르면** 그 설정으로 게임이 재시작됩니다. Python 봇이 포함되면
"환경 세팅 중..." 모달이 잠깐 뜨는데, Pyodide + numpy가 로딩되는 것으로
처음 한 번만 몇 초 걸리고 이후로는 즉시 재개됩니다.
